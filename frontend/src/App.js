    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      {isInitialLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-600 text-white shadow-xl hover:shadow-2xl transition-all">
            <CardContent className="p-4 relative overflow-hidden">
              <div className="absolute -bottom-4 -right-4 opacity-10">
                <svg className="w-32 h-32 animate-spin-slow" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.89-8.9L15 12l-2.11.9c-.39.16-.76.53-.92.92L11 16l-.9-2.11c-.16-.39-.53-.76-.92-.92L7 12l2.11-.9c.39-.16.76-.53.92-.92L11 8l.9 2.11c.16.39.53.76.92.92z"/>
                </svg>
              </div>
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div className="flex-1">
                  <p className="text-sm opacity-90 font-medium">✨ Total Earned</p>
                  <p className="text-3xl font-bold tracking-tight">₹{stats.total_earnings || 0}</p>
